...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			$("#searchForm").attr("action","${ctx}/trade/vShanghuTrade/cslist");
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			$("#searchForm").submit();
        	return false;
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/trade/vShanghuTrade/cslist">交易明细查询</a></li>
<%-- 		<shiro:hasPermission name="trade:vShanghuTrade:edit"><li><a href="${ctx}/trade/vShanghuTrade/form">商户流水添加</a></li></shiro:hasPermission>
 --%>	</ul>
	<form:form id="searchForm" modelAttribute="vShanghuTrade" action="${ctx}/trade/vShanghuTrade/cslist" method="post" class="breadcrumb form-search">
